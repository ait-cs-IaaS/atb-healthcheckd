% healthcheckd(SECTION) | User Commands
%
% "November 22 2023"
...
healthcheckd - program to do something

# SYNOPSIS

**healthcheckd** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**healthcheckd** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **healthcheckd** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**healthcheckd** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    healthcheckd. See **foo.conf**(5) for further details.
...
**healthcheckd** provides some return codes, that can be used in scripts:
...
Roy Mandoline <roy@aecid-testbed.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Roy Mandoline
